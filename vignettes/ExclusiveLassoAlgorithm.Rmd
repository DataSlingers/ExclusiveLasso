...
than zero variables. For now, we are content with a simple approach where
all variables are checked sequentially, regardless of whether they are zero or not.
